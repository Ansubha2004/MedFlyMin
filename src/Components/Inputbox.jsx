...
export default function Inputbox({id,label,type,icon,mode,placeholder,additionalcss}) {
  return (
    <>
        ...
        <div className={clsx("flex justify-start items-center rounded-[8px] border-[#010101B2] border-[2px] w-full h-[50px] border-box px-[20px]  my-[9px] group-focus:border-[orange]",additionalcss)}> 
