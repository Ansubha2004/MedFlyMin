...
export default function Sloganbox({extracss,heading,body,page,index}) {
    ...
    //tailwindcss
    const common='w-full sm:min-h-[170px] rounded-[30px] flex justify-center items-start shadow-[2px_4px_5px_0px_rgba(0,0,0,0.25)] hover:scale-[1.015] active:scale-[1.015] transition-all duration-100 ease-in mb-[15px] sm:mb-[30px] border-box py-[25px] px-[20px] sm:px-[45px] mx-5';
    ...
    <>
        <div className={clsx(common,extracss)}>
            ...
            <div className="h-full flex flex-col justify-between">
                ...
                <p className="leading-snug text-[18px] sm:text-[24px] font-[100] font-[Inter] text-[#000000] opacity-[65%]">{body}</p>
            </div>
        </div>
    </>
  )
