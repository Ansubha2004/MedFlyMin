    ...
    <>
      <div id="about" className="w-full h-auto relative flex flex-col justify-center items-center scroll-mt-[150px] sm:scroll-mt-[80px] mt-10 sm:mt-0 px-[10px] sm:px-0">
        ...
        <div id="Heading" className="w-full h-auto flex flex-col justify-center items-center">
            <p className="leading-snug text-[33px] sm:text-[52px] font-[700]">The <span className="text-[#F2630A]">MedFlyMin</span> Advantage</p>
            <br/>
            <div className="w-[300px] h-[4px] bg-[#F2630A] hidden sm:block"></div>
            
        </div>
        <p className="w-full sm:w-[65%] sm:mt-[48px] text-center text-[18px] sm:text-[32px] sm:leading-[40px] text-[#4D4D4D] font-light">Our platform creates a win-win ecosystem where pharmacies grow their business while customers receive medications faster than ever before.</p>
        <br/>
