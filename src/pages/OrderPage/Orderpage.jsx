...
export default function Orderpage() {
  ...
  return (
    <div className="relative flex flex-col min-h-screen ">
      ...
      <div className="roboto-font w-full mb-[48px] overflow-hidden bg-[#B528971A] min-h-[260px] hidden sm:flex justify-center items-center">
        <img src={advertise} className="h-[194px] object-fit" />
      </div>
      <p className="roboto-font font-[600] text-[18px] sm:text-[32px] border-box px-[20px] sm:px-[50px]">
        Categories
      </p>
      <br />
      <div className="box-border roboto-font px-[20px] sm:px-[50px]  w-full h-auto grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-4">
        {[
          "Fever & Cold",
          "Diabetes Care",
          "Health & BP Care",
      ...
      <div className="roboto-font px-[20px] sm:hidden w-full mt-[24px] mb-[40px]">
        <Button
          specification="s3"
