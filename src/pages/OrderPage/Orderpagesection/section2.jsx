...
function section2() {
  return (
    <div>
        ...
        <div id="prescription" className="bg-[#CD8BB459] roboto-font my-[24px] sm:mb-[24px] sm:mt-[48px]  w-full min-h-[50px] sm:min-h-[90px]  rounded-[10px] border-[1px] border-solid border-[#00000030] flex items-center justify-around">
        ...
        <div id="container" className="roboto-font w-full h-auto flex gap-2 sm:gap-5 overflow-x-auto no-scrollbar ">
        {
