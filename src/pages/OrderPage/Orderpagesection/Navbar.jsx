...
export default function Navbar() {
  ...
  return (
    <nav className="bg-transparent font-[Inter] w-full flex justify-between items-center px-4 sm:px-8 py-2 border-b border-black/60">
      <div className="flex items-center gap-6">
        ...
        <Button 
          ...
          theme="themeorange" 
          specification="s1" 
          additionalcss="hover:opacity-80 duration-100 text-[18px] sm:text-[24px] scale-90" 
          icon={locationicon2} 
      ...
      <div className="text-[16px] sm:text-[20px] flex items-center gap-6 sm:gap-10 relative" ref={dropdownRef}>
        <a href="#help" className={clsx(hoverbuttons)}>Need Help?</a>
        <a href="#cart" className="flex items-center">
          <p className={clsx(hoverbuttons)}>Cart</p>
          <img src={cartimage} alt="Cart" className="h-[30px] sm:h-[40px] ml-1 object-contain" />
        </a>

        <div 
          className="w-[45px] h-[45px] sm:w-[55px] sm:h-[55px] rounded-full overflow-hidden border-2 border-transparent hover:border-orange-600 transition-transform duration-200 hover:scale-110 active:scale-90 cursor-pointer"
